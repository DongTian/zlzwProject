...
namespace zlzw.BLL
{
	...
	/// PartnersListBLL
	/// </summary>
	public partial class PartnersListBLL
	{
		private readonly zlzw.DAL.PartnersListDAL dal=new zlzw.DAL.PartnersListDAL();
		public PartnersListBLL()
		{}
		#region  BasicMethod
		/// <summary>
		/// 是否存在该记录
		...
		{
			return dal.DeleteList(PartnerIDlist );
		}
		...
		public zlzw.Model.PartnersListModel GetModelByCache(int PartnerID)
		{
			...
			if (objModel == null)
			{
				try
				{
					objModel = dal.GetModel(PartnerID);
					if (objModel != null)
					{
