...
{
	/// <summary>
	/// 数据访问类:JobCategoryListDAL
	/// </summary>
	public partial class JobCategoryListDAL
	{
		public JobCategoryListDAL()
		{}
		#region  Method
		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(int JobCategoryID)
		{
			int rowsAffected;
			...
			int result= DbHelperSQL.RunProcedure("JobCategoryList_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public bool Delete(int JobCategoryID)
		{
			...
			DbHelperSQL.RunProcedure("JobCategoryList_Delete",parameters,out rowsAffected);
			if (rowsAffected > 0)
			{
				return true;
			}
		...
		/// 批量删除数据
		/// </summary>
		public bool DeleteList(string JobCategoryIDlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from JobCategoryList ");
			strSql.Append(" where JobCategoryID in ("+JobCategoryIDlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select JobCategoryID,JobCategoryGUID,JobCategoryName,JobCount,PublishDate,IsHot,IsEnable,Other01,Other02 ");
			strSql.Append(" FROM JobCategoryList ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" JobCategoryID,JobCategoryGUID,JobCategoryName,JobCount,PublishDate,IsHot,IsEnable,Other01,Other02 ");
			strSql.Append(" FROM JobCategoryList ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM JobCategoryList ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.JobCategoryID desc");
			}
			strSql.Append(")AS Row, T.*  from JobCategoryList T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "JobCategoryList";
			parameters[1].Value = "JobCategoryID";
