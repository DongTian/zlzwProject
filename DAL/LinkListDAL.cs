...
namespace zlzw.DAL
{
    ...
    /// 数据访问类:LinkListDAL
    /// </summary>
    public partial class LinkListDAL
    {
        public LinkListDAL()
        { }
        #region  Method
        ...
        public bool Exists(int LinkID)
        {
            ...
            int result = DbHelperSQL.RunProcedure("LinkList_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        public int Add(zlzw.Model.LinkListModal model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@LinkTitle", SqlDbType.NVarChar,50),
					new SqlParameter("@LinkTarget", SqlDbType.NVarChar,200),
					new SqlParameter("@LinkImage", SqlDbType.NVarChar,200),
            ...
            DbHelperSQL.RunProcedure("LinkList_ADD", parameters, out rowsAffected);
        ...
        public bool Update(zlzw.Model.LinkListModal model)
        {
            ...
            DbHelperSQL.RunProcedure("LinkList_Update", parameters, out rowsAffected);
            if (rowsAffected > 0)
            {
                return true;
            }
        ...
        public bool Delete(int LinkID)
        {
            ...
            DbHelperSQL.RunProcedure("LinkList_Delete", parameters, out rowsAffected);
            if (rowsAffected > 0)
            {
                return true;
            }
        ...
        public bool DeleteList(string LinkIDlist)
        {
            ...
            strSql.Append("delete from LinkList ");
        ...
        public zlzw.Model.LinkListModal GetModel(int LinkID)
        {
            ...
            zlzw.Model.LinkListModal model = new zlzw.Model.LinkListModal();
            DataSet ds = DbHelperSQL.RunProcedure("LinkList_GetModel", parameters, "ds");
        ...
        /// 得到一个对象实体
        /// </summary>
        public zlzw.Model.LinkListModal DataRowToModel(DataRow row)
        {
            zlzw.Model.LinkListModal model = new zlzw.Model.LinkListModal();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select LinkID,LinkGUID,LinkTitle,LinkTarget,LinkImage,PublishDate,LinkType,LinkDesc,IsEnable,Other01,Other02,Other03 ");
            strSql.Append(" FROM LinkList ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" LinkID,LinkGUID,LinkTitle,LinkTarget,LinkImage,PublishDate,LinkType,LinkDesc,IsEnable,Other01,Other02,Other03 ");
            strSql.Append(" FROM LinkList ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM LinkList ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from LinkList T ");
