<%@ Page Language="C#" MasterPageFile="~/MasterPage/OnlineApplication.Master" AutoEventWireup="true" CodeBehind="OnlineApplication.aspx.cs" Inherits="WebApp.OnlineApplication" Title="校企英才官网-招聘动态" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content">
        <div class="main">
            ...
            <div class="bar">
                <b>招聘动态</b>
                <span>当前位置：<a href="../default.aspx">首页</a> > <a href="#">招聘动态</a></span>
            </div>
            <div class="left1">
                <div class="wenti1">
                    <dl>
                        <a href="OnlineApplication.aspx" style="text-decoration:none;color:#fff;">
                            <dt class="expand1" style="color:#fff;">招聘动态</dt>
                        </a>
                    </dl>
                </div>
            </div>
                ...
                <ul>
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td align="center">
                                <p>
                                    <asp:Label ID="labEmptyInfo" runat="server" Visible="false"  style="text-align:center;"><span style="font-size:16px; color:#314777;">暂无该地区相关职位信息</span></asp:Label>
                                </p>
                            </td>
                        </tr>
                    </table>
