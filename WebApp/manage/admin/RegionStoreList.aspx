<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegionStoreList.aspx.cs" Inherits="WebApp.manage.admin.RegionStoreList" %>
    ...
    <ext:Panel ID="Panel1" runat="server" Layout="Fit" ShowBorder="False" ShowHeader="false"
        ...
        <Toolbars>
            <ext:Toolbar ID="Toolbar2" runat="server">
                <Items>
                    <ext:Button ID="btnAdd" runat="server" Text="添加所属区域" Icon="Add">
                    </ext:Button>
                    <ext:ToolbarSeparator ID="ToolbarSeparator1" runat="server"></ext:ToolbarSeparator>
                    <ext:Button ID="btnDel" runat="server" Text="删除所属区域" Icon="BulletCross" OnClick="btnDel_Click"></ext:Button>
                </Items>
            </ext:Toolbar>
        </Toolbars>
        <Items>
            <ext:Grid ID="grid1" PageSize="15" ShowBorder="true" ShowHeader="false"
                ...
                Width="800px" DataKeyNames="DictionaryListID" OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowNumber="True" IsDatabasePaging="true" 
                OnRowDataBound="Grid1_RowDataBound" ForceFitAllTime="true" AutoPostBack="False">
                <Columns>
                    <ext:BoundField Width="200px" DataField="DictionaryValue" HeaderText="区域名称" TextAlign="Center" />
                    <ext:BoundField Width="200px" DataField="DictionaryKey" HeaderText="区域索引" TextAlign="Center" />
                    <ext:BoundField Width="200px" DataField="DictionaryDesc" HeaderText="区域简介" TextAlign="Center" />
                    <ext:BoundField Width="50px" DataField="OrderNumber" HeaderText="排序" TextAlign="Center"/>
                    ...
                    <ext:TemplateField HeaderText="编辑操作" TextAlign="Center">
                        <ItemTemplate>
                            <a style="text-decoration:none;" href="<%# GetEditUrl(DataBinder.Eval(Container.DataItem, "[DictionaryListID]")) %>">编辑</a>
                        </ItemTemplate>
                    </ext:TemplateField>
                </Columns>
            </ext:Grid>
