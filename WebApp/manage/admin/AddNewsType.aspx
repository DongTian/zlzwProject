<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewsType.aspx.cs" Inherits="WebApp.manage.admin.AddNewsType" %>
            ...
            <Toolbars>
                <ext:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <ext:ToolbarText ID="ToolbarText2" Text="添加一个新的新闻类型　" runat="server">
                        </ext:ToolbarText>
                    </Items>
                </ext:Toolbar>
            </Toolbars>
                ...
                <ext:Panel ID="Panel2" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" Height="450px">
                    <Items>
                        <ext:SimpleForm ID="SimpleForm1" ShowBorder="true" ShowHeader="false" EnableLightBackgroundColor="true"
                            ...
                            <Items>
                                <ext:TextBox ID="txbNewsTypeName" runat="server" Label="新闻类型名称" EmptyText="新闻类型名称" Required="true"
                                    RequiredMessage="新闻类型名称不能为空">
                                </ext:TextBox>
                                <ext:TextBox ID="txbNewsTypeIndex" runat="server" Label="新闻类型索引" EmptyText="建议使用新闻类型名称的中文全拼" Required="true" RequiredMessage="新闻类型索引不能为空"></ext:TextBox>
