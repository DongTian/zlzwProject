<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndicatorsList.aspx.cs" Inherits="WebApp.manage.admin.IndicatorsList" %>
    ...
    <ext:Panel ID="Panel1" runat="server" Layout="Fit" ShowBorder="False" ShowHeader="false"
        ...
        <Toolbars>
            <ext:Toolbar ID="Toolbar2" runat="server">
                <Items>
                    <ext:Button ID="btnAdd" runat="server" Text="添加评比" Icon="Add">
                    </ext:Button>
                    <ext:ToolbarSeparator ID="ToolbarSeparator1" runat="server"></ext:ToolbarSeparator>
                    <ext:Button ID="btnDel" runat="server" Text="删除指标" Icon="BulletCross" OnClick="btnDel_Click"></ext:Button>
                </Items>
            </ext:Toolbar>
        </Toolbars>
        <Items>
            <ext:Grid ID="grid1" PageSize="15" ShowBorder="true" ShowHeader="false"
                ...
                <Columns>
                    <ext:BoundField Width="200px" DataField="DictionaryValue" HeaderText="指标名称" TextAlign="Center" />
                    <ext:BoundField Width="200px" DataField="DictionaryKey" HeaderText="类型索引" TextAlign="Center" />
                    <ext:BoundField Width="200px" DataField="DictionaryDesc" HeaderText="类型简介" TextAlign="Center" />
