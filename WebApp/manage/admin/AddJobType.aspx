<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddJobType.aspx.cs" Inherits="WebApp.manage.admin.AddJobType" %>
            ...
            <ext:Panel ID="Panel2" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" Height="450px">
                <Items>
                    <ext:SimpleForm ID="SimpleForm1" ShowBorder="true" ShowHeader="false" EnableLightBackgroundColor="true"
                        ...
                        <Items>
                            <ext:TextBox ID="txbJobTypeName" runat="server" Label="岗位类型名称" EmptyText="岗位类型名称" Required="true"
