<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddJob.aspx.cs" Inherits="WebApp.manage.admin.AddJob" %>
            ...
            <ext:Panel ID="Panel2" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" Height="450px">
                <Items>
                    <ext:SimpleForm ID="SimpleForm1" ShowBorder="true" ShowHeader="false" EnableLightBackgroundColor="true"
                        ...
                        <Items>
                            <ext:TextBox ID="txbJobName" runat="server" Label="岗位名称" EmptyText="岗位名称" Required="true"
                                RequiredMessage="岗位名称不能为空">
                            </ext:TextBox>
                            <ext:DropDownList ID="drpJobType" runat="server" Label="岗位类型"></ext:DropDownList>
