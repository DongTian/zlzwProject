<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobKindList.aspx.cs" Inherits="WebApp.manage.admin.JobKindList" %>
    ...
    <ext:Panel ID="Panel1" runat="server" Layout="Fit" ShowBorder="False" ShowHeader="false"
        ...
        <Items>
            <ext:Grid ID="grid1" PageSize="15" ShowBorder="true" ShowHeader="false"
                ...
                Width="800px" DataKeyNames="JobKindGUID" OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowNumber="True" IsDatabasePaging="true" 
                OnRowDataBound="Grid1_RowDataBound" ForceFitAllTime="true" AutoPostBack="False">
                <Columns>
                    <ext:BoundField Width="200px" DataField="JobKindName" HeaderText="岗位名称" TextAlign="Center" />
                    <ext:BoundField Width="150px" DataField="JobCategoryGUID" HeaderText="岗位分类" TextAlign="Center" />
                    <ext:CheckBoxField Width="60px" RenderAsStaticField="true" DataField="IsHot" HeaderText="热门岗位" TextAlign="Center" />
                    <ext:CheckBoxField Width="60px" RenderAsStaticField="true" DataField="IsShowDefaultPage" HeaderText="首页显示" TextAlign="Center" />
                    ...
                    <ext:TemplateField HeaderText="编辑操作" TextAlign="Center">
                        <ItemTemplate>
                            <a style="text-decoration:none;" href="<%# GetEditUrl(DataBinder.Eval(Container.DataItem, "[JobKindGUID]")) %>">编辑</a>
                        </ItemTemplate>
                    </ext:TemplateField>
                </Columns>
            </ext:Grid>
