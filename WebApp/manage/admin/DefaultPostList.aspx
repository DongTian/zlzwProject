<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultPostList.aspx.cs" Inherits="WebApp.manage.admin.DefaultPostList" %>
    ...
    <ext:Panel ID="Panel1" runat="server" Layout="Fit" ShowBorder="False" ShowHeader="false"
        ...
        <Toolbars>
            <ext:Toolbar ID="Toolbar2" runat="server">
                <Items>
                    <ext:Button ID="btnAdd" runat="server" Text="添加职位信息" Icon="Add">
                    </ext:Button>
                    <ext:ToolbarSeparator ID="ToolbarSeparator1" runat="server"></ext:ToolbarSeparator>
                    <ext:Button ID="btnDel" runat="server" Text="删除职位信息" Icon="BulletCross" OnClick="btnDel_Click"></ext:Button>
                </Items>
            </ext:Toolbar>
        </Toolbars>
        <Items>
            <ext:Grid ID="grid1" PageSize="15" ShowBorder="true" ShowHeader="false"
                ...
                Width="800px" DataKeyNames="EnterpriseID" OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowNumber="True" IsDatabasePaging="true" 
                OnRowDataBound="Grid1_RowDataBound" ForceFitAllTime="true">
                <Columns>
                    <ext:BoundField Width="100px" DataField="DictionaryListID" HeaderText="所属地区" TextAlign="Center" />
                    <ext:BoundField Width="150px" DataField="EnterpriseName" HeaderText="公司名称" TextAlign="Center" />
                    <ext:BoundField Width="150px" DataField="WorkAdd" HeaderText="工作地点" TextAlign="Center" />
                    <ext:BoundField Width="100px" DataField="RecruitmentNumber" HeaderText="招聘人数" TextAlign="Center" />
                    ...
                    <ext:TemplateField HeaderText="编辑操作" TextAlign="Center">
                        <ItemTemplate>
                            <a style="text-decoration:none;" href="<%# GetEditUrl(DataBinder.Eval(Container.DataItem, "[EnterpriseID]")) %>">编辑</a>
                        </ItemTemplate>
                    </ext:TemplateField>
                </Columns>
            </ext:Grid>
